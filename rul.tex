...
\begin{table}[tb]
    ...
    \midrule
    %
    Class 0 \par (0 kN, 0\%) & 0.98 & 0.98 & 0.98 & 81 \\
    %
    Class 1 \par (11.7 kN, 33\%) & 0.95 & 0.96 & 0.95 & 54 \\
    %
    Class 2 \par (11.7 kN, 67\%) & 0.95 & 0.96 & 0.95 & 54 \\
    %
    Class 3 \par (12.7 kN, 33\%) & 0.67 & 0.76 & 0.71 & 54 \\
    %
    Class 4 \par (12.7 kN, 67\%) & 0.75 & 0.78 & 0.76 & 54 \\
    %
    Class 5 \par (14.7 kN, 33\%) & 0.79 & 0.69 & 0.73 & 54 \\
    %
    Class 6 \par (14.7 kN, 67\%) & 0.76 & 0.70 & 0.73 & 54 \\
    \midrule
    %
    Macro Average & 0.83 & 0.83 & 0.83 & 405 \\ 
    %
    Weighted Average & 0.84 & 0.84 & 0.84 & 405 \\ 
    \bottomrule
    \end{tabularx}
\end{table}
